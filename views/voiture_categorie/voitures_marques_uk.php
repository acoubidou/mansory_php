<?php 
    ...
    $array = [
        ["aston_martin","250px","Aston Martin", "bentley", "250px", "Bentley", "land_rover", "350px", "Land Rover", "lotus", "150px", "Lotus"],
    ];
    $array2 = [
        ["mclaren", "250px", "Mclaren", "rolls_royce", "180px", "Rolls Royce"]
    ];
?>
    ...
    <?php 
            ...
            foreach ($array2 as list($marque1, $taille1, $nom1, $marque2, $taille2, $nom2,)){
                echo('
                <!-- Voiture -->
                <div class="row align-items-center pt-5 pb-3">
                    <div class="col-3 d-flex flex-column text-center">
